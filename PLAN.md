# Intelligent Booking Platform — Build Plan
...
Domain-driven modular monolith with service boundaries: Next.js frontend; Hono API; Go availability engine; PostgreSQL/Prisma; Redis locks and jobs; Gemini recommendation adapter.
...
Next.js, TypeScript, shadcn/ui, Zustand, Hono, Go, Prisma, PostgreSQL, Redis, Gemini API, Docker

## Core domain

Organization, Location, Resource, Provider, Schedule, AvailabilityRule, Slot, Booking, Membership, Payment, Waitlist, Reminder.

## API strategy

GraphQL for availability reads and booking views; REST command endpoints with idempotency keys; webhooks for payments/calendars.
